...
class MainActivity : AppCompatActivity() {
    ...
    private var mHelloListener: View.OnClickListener? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mMsgView = findViewById<View>(R.id.id_text_view) as TextView
                ...
                object : BroadcastReceiver() {
                    override fun onReceive(context: Context, intent: Intent) {
                        ...
                        if (latitude != null && longitude != null) {
                            ...
                            val newLocation = "Latitude : $latitude\nLongitude: $longitude"
                            Toast.makeText(applicationContext, newLocation, Toast.LENGTH_SHORT).show()
                        }
                    }
                }, IntentFilter(LocationMonitoringService.ACTION_LOCATION_BROADCAST)
        //TODO - persist location to SQLite db, internal storage, cache file, Wiki Leaks, Google, Facebook, CIA, KGB, etc...
        )
    }

    init {
        mHelloListener = View.OnClickListener {
            Toast.makeText(applicationContext, "Starting location monitoring service.", Toast.LENGTH_SHORT).show()
            startStep1()
        }
    }
    ...
    private fun startStep3() {
        ...
        if (!mAlreadyStartedService && mMsgView != null) {
            ...
            val locationCheckIntervalString = resources.getString(R.string.locationCheckInterval)
            val fastestLocationCheckIntervalString = resources.getString(R.string.fastestLocationCheckInterval)

            val locationCheckInterval = Integer.valueOf(locationCheckIntervalString)
            val fastestLocationCheckInterval = Integer.valueOf(fastestLocationCheckIntervalString)
